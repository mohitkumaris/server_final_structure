...
instantiateChaincode(peers, channelName, chaincodeName, chaincodeVersion,"test",chaincodeType,"", username, org_name)
	.then(data => console.log(data)).catch(err => console.log(err));

async function instantiateChaincode(peers, channelName, chaincodeName, chaincodeVersion, functionName, chaincodeType, args, username, org_name) {
